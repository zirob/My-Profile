...
const translations = {
  en: {
    pageTitle: "Boris Ramirez | Portfolio", description: "Boris Ramirez's portfolio, experience, projects, and technical skills.", logoLabel: "Go to homepage", menuToggle: "Toggle navigation", languageLabel: "Select language",
    ...
    projectsLabel: "Projects", projectsTitle: "Things I'm building", projectOneTitle: "Personal Portfolio Infrastructure", projectOneCopy: "A portfolio hosted on an Amazon EC2 instance with Nginx, an Elastic IP, and secure administration through AWS Systems Manager Session Manager.", projectTwoTitle: "This Portfolio Website", projectTwoCopy: "A responsive, accessible personal site built with semantic HTML, modern CSS, and lightweight JavaScript—without a framework.", nextProject: "Next project", nextProjectCopy: "This space is ready for the next challenge, experiment, or useful tool I build.", comingSoon: "Coming soon",
    skillsLabel: "Skills", skillsTitle: "Tools and technologies", cloud: "Cloud", systems: "Systems", systemsList: "Linux, Nginx, SSH, networking fundamentals", development: "Development", practices: "Practices", practicesList: "Security basics, documentation, troubleshooting",
  ...
  es: {
    pageTitle: "Boris Ramirez | Portafolio", description: "Portafolio, experiencia, proyectos y habilidades técnicas de Boris Ramirez.", logoLabel: "Ir al inicio", menuToggle: "Abrir o cerrar navegación", languageLabel: "Seleccionar idioma",
    ...
    projectsLabel: "Proyectos", projectsTitle: "Lo que estoy construyendo", projectOneTitle: "Infraestructura del portafolio personal", projectOneCopy: "Un portafolio alojado en una instancia Amazon EC2 con Nginx, una Elastic IP y administración segura mediante AWS Systems Manager Session Manager.", projectTwoTitle: "Este sitio web de portafolio", projectTwoCopy: "Un sitio personal responsivo y accesible, creado con HTML semántico, CSS moderno y JavaScript ligero, sin frameworks.", nextProject: "Próximo proyecto", nextProjectCopy: "Este espacio está listo para el próximo desafío, experimento o herramienta útil que construya.", comingSoon: "Próximamente",
    skillsLabel: "Habilidades", skillsTitle: "Herramientas y tecnologías", cloud: "Cloud", systems: "Sistemas", systemsList: "Linux, Nginx, SSH, fundamentos de redes", development: "Desarrollo", practices: "Prácticas", practicesList: "Fundamentos de seguridad, documentación, resolución de problemas",
